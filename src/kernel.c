...
void kernel_main()
{
	...
	term_print("| |    | ||  ____|| |     | |     |  __  |      /              \\    /              \\\n");
	term_print("| |_ __| || |____ | |     | |     | |  | |     /    _________   \\  /    ___________/\n");
	term_print("|  ____  ||  ____|| |     | |     | |  | |     |   |         |   | |   |\n");
	term_print("| |    | || |____ | |____ | |____ | |__| |     |   |         |   | |   | \n");       
	term_print("|_|    |_||______||______||______||______|     |   |         |   | |   |____________ \n");        
	term_print(" _       _  ______  _______   _       _____    |   |         |   | \\               \\\n");
